...
def voxel_array(image_path):
    """
    Function to get image voxel array
    Takes image path (str); returns voxel data as arr
    """
    image_read = nib.load(image_path)
    return image_read.get_fdata()
