...
def avg_vol(subj_id, reference_img):
    ...
    # fix: specify which image was used for this (as an insertable, {tissue})
    nib.save(intercept_img, f'{anat_dir}/{subj_id}/{subj_id}_wm_intercept.nii.gz')
    nib.save(slope_img, f'{anat_dir}/{subj_id}/{subj_id}_wm_slope.nii.gz')
